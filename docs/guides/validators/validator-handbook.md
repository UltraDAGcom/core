...
**Target Audience:** Validators, stakers, consensus participants
...
4. [Rewards & Economics](#rewards--economics)
5. [Validator Responsibilities](#validator-responsibilities)
6. [Best Practices](#best-practices)
7. [Slashing & Penalties](#slashing--penalties)
...
**No Slashing:** UltraDAG currently does not implement economic slashing.

**Equivocation Handling:**
- Detected: Producing two vertices in same round
- Penalty: Permanent ban from network
- Evidence: Broadcast to all peers
- No economic penalty (yet)

### Future Slashing Mechanisms

**Planned for Future Versions:**

**1. Equivocation Slashing**
- Penalty: 100% stake confiscation
- Evidence: Two conflicting vertices
- Distribution: Burned or to treasury
