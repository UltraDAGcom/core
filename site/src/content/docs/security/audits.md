---
title: "Audit Reports"
description: "Multi-pass audit results with 188+ bugs found and fixed, dependency audit, and test coverage"
order: 2
section: "security"
---
...
See [Formal Verification](/docs/technical/formal-verification) for full details.
...
- [Security Model](/docs/security/model) — full security architecture
- [Bug Bounty](/docs/security/bug-bounty) — report a vulnerability
- [Formal Verification](/docs/technical/formal-verification) — TLA+ specification
