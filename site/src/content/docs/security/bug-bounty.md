...
description: "Active bug bounty with up to 50,000 UDAG rewards for critical vulnerability disclosures"
order: 3
section: "security"
---
...
<div class="callout callout-warning"><div class="callout-title">Do not disclose publicly</div>Please do not open public GitHub issues for security vulnerabilities. Use the private Security Advisories feature. The 90-day embargo gives us time to develop and deploy a fix.</div>
...
- [Security Model](/docs/security/model) — understanding the security architecture
- [Audit Reports](/docs/security/audits) — past audit findings
