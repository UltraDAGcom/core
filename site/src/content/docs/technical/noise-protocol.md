...
description: "P2P transport encryption with Noise_XX, forward secrecy, validator identity binding, and message chunking"
order: 3
section: "technical"
---
...
<div class="callout callout-info"><div class="callout-title">Encryption without authentication</div>Observer connections provide **confidentiality** (traffic is encrypted) but not **authentication** (the peer's identity is not verified). This is appropriate for nodes that do not produce vertices and have no stake at risk.</div>
...
- [Checkpoint Protocol](/docs/technical/checkpoints) — state sync over encrypted channels
