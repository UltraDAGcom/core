---
title: "CLI Reference"
description: "Complete reference for all ultradag-node command-line flags and environment variables"
order: 4
section: "operations"
---
...
<div class="callout callout-note"><div class="callout-title">Precedence</div>CLI flags take precedence over environment variables. Environment variables are primarily used in Docker and Fly.io deployments via the entrypoint script.</div>
...
- [Node Operator Guide](/docs/operations/node-guide) -- deployment and operations
- [Docker Guide](/docs/getting-started/docker) -- container deployment
- [Validator Handbook](/docs/operations/validator-handbook) -- validator-specific guidance
