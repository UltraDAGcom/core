...
- Hardware: any Linux SBC that can run the ~3.5 MB stripped aarch64 binary (1 CPU core, 256 MB RAM minimum — Raspberry Pi Zero 2 W works, verified via cross-compile + Debian arm64 container smoke test)
