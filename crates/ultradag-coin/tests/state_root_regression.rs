...
fn state_root_regression_known_fixture() {
    ...
    // Updated 2026-04-10: regenerated after adding validator_emission_percent,
    // ecosystem_emission_percent, and reserve_emission_percent to GovernanceParams
    // as part of the April 2026 tokenomics update (7-bucket model).
    let expected: [u8; 32] = [
        0xfa, 0xeb, 0xa2, 0x77, 0xf2, 0x84, 0x69, 0xa9,
        0x54, 0x61, 0xa2, 0x0c, 0xd0, 0x5c, 0x19, 0x70,
        0xb2, 0x13, 0xc5, 0x90, 0x7a, 0x26, 0x53, 0x05,
        0x07, 0x49, 0x41, 0x1d, 0x6e, 0x3b, 0xe5, 0x99,
    ];
