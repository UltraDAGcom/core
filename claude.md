...
- **Addressed concerns (already protected):**
  - **Governance timelock self-reference**: `execute_at_round` is computed at Active→PassedPending transition and is IMMUTABLE. Reducing `execution_delay_rounds` via governance only affects FUTURE proposals. Documented in engine.rs lines 1864-1872.
